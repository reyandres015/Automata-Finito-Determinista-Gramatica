class L3:
    ...
    def validar_cadena(self, cadena):
        ...
        # Verificación del estado final y de la condición a^nb^(n+1)
        if estado_actual == 'A' and count_a > 0 and count_b > 1 and count_b == count_a + 1:
            return True
        else:
            return False
...
if __name__ == "__main__":
    ...
    resultado = l3.validar_cadena(cadena)  # True
    print(
